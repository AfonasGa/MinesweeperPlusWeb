var Godot = ( () => {
    ...
    return (async function(moduleArg={}) {
        ...
        function _godot_js_emscripten_get_version() {
            const emscriptenVersionPtr = GodotRuntime.allocString("4.0.10");
        ...
        var GodotWebXR = {
            ...
            monkeyPatchRequestAnimationFrame: enable => {
                ...
                MainLoop.requestAnimationFrame = enable ? GodotWebXR.requestAnimationFrame : GodotWebXR.orig_requestAnimationFrame
            }
            ,
            pauseResumeMainLoop: () => {
                MainLoop.pause();
        ...
        Module["cwrap"] = cwrap;
        var _free, __Z14godot_web_mainiPPc, _main, _malloc, _fflush, __emwebxr_on_input_event, __emwebxr_on_simple_event, ___funcs_on_exit, __emscripten_timeout, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current;
        function assignWasmExports(wasmExports) {
            Module["_free"] = _free = wasmExports["qf"];
            Module["__Z14godot_web_mainiPPc"] = __Z14godot_web_mainiPPc = wasmExports["rf"];
            Module["_main"] = _main = wasmExports["sf"];
            Module["_malloc"] = _malloc = wasmExports["tf"];
            _fflush = wasmExports["uf"];
            Module["__emwebxr_on_input_event"] = __emwebxr_on_input_event = wasmExports["vf"];
            Module["__emwebxr_on_simple_event"] = __emwebxr_on_simple_event = wasmExports["wf"];
            ___funcs_on_exit = wasmExports["yf"];
            __emscripten_timeout = wasmExports["zf"];
        ...
        var wasmImports = {
            ...
            bb: _glRenderbufferStorageMultisample,
            wa: _glScissor,
            hb: _glShaderSource,
            kb: _glStencilFunc,
            ha: _glStencilMask,
            ...
            Xa: _godot_js_webmidi_close_midi_inputs,
            ...
            cb: _godot_webgl2_glFramebufferTextureMultisampleMultiviewOVR,
            ...
            GL.getSource = (shader, count, string, length) => {
                ...
                for (let i = 0; i < count; ++i) {
                    ...
                    if (len) {
                        ...
                        const slice = HEAPU8.buffer instanceof ArrayBuffer ? HEAPU8.subarray(ptr, endPtr) : HEAPU8.slice(ptr, endPtr);
